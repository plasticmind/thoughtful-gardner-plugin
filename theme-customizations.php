<?php
/**
 * Plugin Name: Thoughtful Gardner Theme Customisations
 * Description: Customizations for the Galleria WooCommerce child theme
 * Version: 	1.0.0
 * Author: 		Plasticmind
 * Author URI: 	http://www.plasticmind.com/
 *
